    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 7, 12, 204);
    			attr_dev(div0, "class", "modal svelte-8qorpq");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			b = element("b");
    			b.textContent = "Find a voting location in your area!";
    			t7 = space();
    			input = element("input");
    			t8 = space();
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (dirty & /*ZIP*/ 2 && to_number(input.value) !== /*ZIP*/ ctx[1]) {
    				set_input_value(input, /*ZIP*/ ctx[1]);
    			}
