<nav class="w-full flex flex-row flex-wrap bg-white absolute sticky top-0 border-b-2 border-gray-100">
    ...
    <ul class="flex content-center items-center justify-center sm:justify-end px-10 w-1/2 md:w-2/3 lg:w-4/5">
        ...
        <li id="Register" class="text-gray-400 font-main uppercase px-5">
            <a href="/register" class="px-3 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-400 text-base font-main">Register</a>
        </li>
    </ul>
</nav>
