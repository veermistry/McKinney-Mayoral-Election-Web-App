			...
			<div class="page-wrapper">
                ...
                <div class="flex flex-wrap flex-row p-5">
					<div class="w-full md:w-2/3 p-5">
                        <div class="w-full">
							<h1 class = "text-xl"><b>Your Nearest Location: </b><a href = {closestLocation.MapsLink} class="underline text-purple-800">{closestLocation.Name}, {closestLocation.Room} </a></h1>
